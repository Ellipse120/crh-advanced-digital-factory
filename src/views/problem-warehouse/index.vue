  ...
  <div class="app-container">
    <div>
      <el-form :inline="true" :model="query">
        ...
        <el-form-item>
          <el-date-picker v-model="query.date" type="date" clearable placeholder="请选择时间" title="时间" value-format="yyyy-MM-dd" />
        </el-form-item>
        <el-form-item>
          <el-input v-model.trim="query.supervisorName" clearable placeholder="请输入来源" title="来源" />
        </el-form-item>
        <el-form-item>
          <el-input v-model.trim="query.supervisorName" clearable placeholder="请输入分类" title="分类" />
        </el-form-item>
        <el-form-item>
          <el-input v-model.trim="query.supervisorName" clearable placeholder="请输入文件名" title="文件名" />
        </el-form-item>
        <el-form-item>
          <el-input v-model.trim="query.supervisorName" clearable placeholder="请输入文号" title="文号" />
        </el-form-item>
        <el-form-item>
    ...
    >
      ...
      <el-table-column label="分类" prop="operationTime" align="center" />
      <el-table-column label="子类" prop="operationTime" align="center" />
      <el-table-column label="文件名" prop="time" align="center" />
      <el-table-column label="文号" prop="time" align="center" />
      <el-table-column label="文种" prop="time" align="center" />
      <el-table-column label="问题" prop="time" align="center" />
      <el-table-column label="责任单位/部门/班组" prop="time" align="center" />
      <el-table-column label="整改措施" prop="time" align="center" />
      <el-table-column label="整改期限" prop="time" align="center" />
      <el-table-column label="是否销号" prop="time" align="center" />
      <el-table-column label="备注" prop="time" align="center" show-overflow-tooltip />
    </el-table-wrapper>
