<template>
  <div class="app-container page-content--menu-management">
...
<style lang="scss">
.page-content--menu-management {

  .cell--english-name .cell,
  .cell--comments .cell {
    white-space: nowrap;
    overflow: hidden;
...
.dialog--per-user-role-privileges-assignment {
  overflow: hidden;
  ...
  hr {
    ...
    border-width: 0;
    height: 100%;
    background-image: linear-gradient(to bottom, transparent 0%, #e3e3e3 5%, #e3e3e3 95%, transparent 100%);
  }
...
.el-select-popper--per-user-role-privileges--user-role {
